  ...
  public async run(client: Janet, ctx: Context, args: string[]): Promise<void> {
    ...
    if (!args[0]) {
      ...
      const helpEmbed = embed
        ...
        .setTitle("Help Menu")
        .setDescription(
          `Hey there! I'm ${this.client.user.username}, a music bot made with [Janet](https://github.com/brblacky/Janet) and Discord.js. You can use \`${prefix}help <command>\` to get more info on a command.`
        )
        .setFooter({
